...
import static de.androidcrypto.taplinxexample.Constants.ALIAS_DEFAULT_FF;
import static de.androidcrypto.taplinxexample.Constants.ALIAS_KEY_2KTDES;
import static de.androidcrypto.taplinxexample.Constants.ALIAS_KEY_2KTDES_ULC;
import static de.androidcrypto.taplinxexample.Constants.ALIAS_KEY_AES128;
import static de.androidcrypto.taplinxexample.Constants.ALIAS_KEY_AES128_ZEROES;
import static de.androidcrypto.taplinxexample.Constants.EMPTY_SPACE;
import static de.androidcrypto.taplinxexample.Constants.EXTRA_KEYS_STORED_FLAG;
import static de.androidcrypto.taplinxexample.Constants.KEY_AES128_DEFAULT;
import static de.androidcrypto.taplinxexample.Constants.KEY_APP_MASTER;
import static de.androidcrypto.taplinxexample.Constants.PRINT;
import static de.androidcrypto.taplinxexample.Constants.STORAGE_PERMISSION_WRITE;
import static de.androidcrypto.taplinxexample.Constants.TOAST;
import static de.androidcrypto.taplinxexample.Constants.TOAST_PRINT;
import static de.androidcrypto.taplinxexample.Constants.packageKey;
import static de.androidcrypto.taplinxexample.Constants.bytesKey;
import static de.androidcrypto.taplinxexample.Constants.cipher;
import static de.androidcrypto.taplinxexample.Constants.default_ff_key;
import static de.androidcrypto.taplinxexample.Constants.default_zeroes_key;
import static de.androidcrypto.taplinxexample.Constants.iv;
import static de.androidcrypto.taplinxexample.Constants.objKEY_2KTDES;
import static de.androidcrypto.taplinxexample.Constants.objKEY_2KTDES_ULC;
import static de.androidcrypto.taplinxexample.Constants.objKEY_AES128;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        if (item.getItemId() == R.id.text_write) {
                        ...
                        if (item.getItemId() == R.id.text_about) {
